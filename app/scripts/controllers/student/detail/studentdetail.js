    ...
    function StudentDetailCtrl($state,$scope,StudentService,$stateParams,$interval,$timeout,RESOURCES) {
      ...
      //Render Calendar
        ...
        function loadGeneral(data, student){
                ...
                vm.student.personal.college_bound = _.get(data,'student.college_bound',"");
                vm.student.personal.emergency1.name = _.get(data,'student.emergency1_name',"");
                vm.student.personal.emergency1.phone = formatPhoneNumber(_.get(data,'student.emergency1_phone',""));
                vm.student.personal.emergency1.email = _.get(data,'student.emergency1_email',"");
                vm.student.personal.emergency1.relationship = _.get(data,'student.emergency1_relationship',"");
                vm.student.personal.emergency2.name = _.get(data,'student.emergency2_name',"");
                vm.student.personal.emergency2.phone = formatPhoneNumber(_.get(data,'student.emergency2_phone',""));
                vm.student.personal.emergency2.email = _.get(data,'student.emergency2_email',"");
                vm.student.personal.emergency2.relationship = _.get(data,'student.emergency2_relationship',"");
